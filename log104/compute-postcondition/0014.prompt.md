...
#Overall this is what the function does: The function accepts a square matrix of integers and returns the sum of all elements along the primary and secondary diagonals of the matrix.

```

Return Postconditions: The program returns the total, which is equal to the sum of all elements along the primary and secondary diagonals of the square matrix of size n.
