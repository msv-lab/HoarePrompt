...
#Overall this is what the function does: The function accepts a parameter x and returns x increased by 1 if x is greater than 0; if x is between -10 and 0 (inclusive), it returns x unchanged; if x is less than -10, it returns x decreased by 10.

```

Return Postconditions: The program returns the integer value of x, which is either increased by 1 if greater than 0, remains unchanged if between -10 and 0 (inclusive), or decreased by 10 if less than -10.
