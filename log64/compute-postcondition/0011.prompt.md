...
#Overall this is what the function does: The function accepts a parameter x and returns x if x is less than or equal to 0.

```

Return Postconditions: The program returns x which is less than or equal to 0
