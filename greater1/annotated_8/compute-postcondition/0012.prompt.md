...
Your Task:
Precondition: `numbers` is a list of integers, `total` is increased by the value of `num`, `count` is increased by 1, and the last element `num` is greater than 1
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is a list of integers, `total` is increased by the value of `num`, `count` is increased by 1, and the last element `num` is greater than 1
else part: `numbers` is a list of integers, `total` is increased by the value of `num`, `count` is increased by 1, and the last element `num` is greater than 1
