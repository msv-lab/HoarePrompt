...
Your Task:
Precondition: `numbers` is a list of integers with the last element removed, `total` is 0, `count` is 0, and `num` contains the value of the removed element
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is a list of integers with the last element removed, `total` is the sum of the removed element, `count` is 1, `num` contains the value of the removed element
else part: `numbers` is a list of integers with the last element removed, `total` is 0, `count` is 0, `num` contains the value of the removed element, and the code prints 'Skipping non-positive number:' followed by the value in `num`
