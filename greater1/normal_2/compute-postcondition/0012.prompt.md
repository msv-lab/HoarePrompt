...
Your Task:
Precondition: numbers have the last element removed, total is updated based on the conditions, count is updated based on the conditions
Program Fragment:
```
if num > 1:
    total += num
...
else part: numbers have the last element removed, total is updated based on the conditions, count is updated based on the conditions
