...
Your Task:
Precondition: `numbers` is a list of integers with the last element removed, `total` is 0, `count` is 0, and `num` is the last element that was removed from the list
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is a list of integers with the last element removed, `total` is the sum of the previous total and the last removed element, `count` is 1, and `num` is the last element that was removed from the list
else part: `numbers` is a list of integers with the last element removed, `total` is 0, `count` is 0, and `num` is the last element that was removed from the list
