...
Your Task:
Precondition: `numbers` is [1, 2], `total` is 0, `count` is 0, `num` is 3
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is [1, 2], `total` is 3, `count` is 1, `num` is 3
else part: `numbers` is [1, 2], `total` is 0, `count` is 0, `num` is 3
