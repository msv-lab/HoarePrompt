...
Your Task:
Precondition: `numbers` is a list of integers with the last element removed and not empty, `total` and `count` are adjusted based on the value of the last element removed
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is a list of integers with the last element removed and not empty, `total` is adjusted based on the value of the last element removed, `count` is increased by 1
else part: 'numbers' is a list of integers with the last element removed and not empty, 'total' and 'count' are adjusted based on the value of the last element removed
