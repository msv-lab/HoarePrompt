...
Your Task:
Initial State: numbers list has elements removed, `num` contains the last element that was removed, `total` is the sum of all removed elements including the last removed element
```
count += 1
