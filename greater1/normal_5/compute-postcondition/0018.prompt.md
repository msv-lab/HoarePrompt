...
Your Task:
Precondition: Output State: *numbers list still has elements remaining, total and count may need to be adjusted based on the value of num*
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: numbers list still has elements remaining, total and count may need to be adjusted based on the value of num; `count` is increased by 1
else part: numbers list still has elements remaining, total and count may need to be adjusted based on the value of num
