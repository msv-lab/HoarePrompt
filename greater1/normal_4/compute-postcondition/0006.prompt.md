...
Your Task:
Precondition: numbers list has one less element, total is 0, count is 0, num is the last integer removed from the list
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: numbers list has one less element, total is updated to include the value of num, count is incremented by 1, num is the last integer removed from the list
else part: numbers list has one less element, total is 0, count is 0, num is the last integer removed from the list
