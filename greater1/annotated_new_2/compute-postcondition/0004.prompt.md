...
Your Task:
Initial State: `numbers` has the last element removed, `total` is the sum of its previous value and the last element of the list, `count` is 0, `num` is the last element of the list
```
count += 1
