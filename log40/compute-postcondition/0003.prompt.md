...
Your Task:
Initial State: *n is a non-negative integer. If n is less than or equal to 1, the function returns n. Otherwise, there is no change to the state of n after the execution of the if statement.
```
prev, curr = 0, 1
