...
Return Postconditions: Case_1: *n is a non-negative integer. If n is less than or equal to 1, the function returns n. Otherwise, there is no change to the state of n after the execution of the if statement.

Case_2: The program returns the last value of 'prev' after the loop finishes
