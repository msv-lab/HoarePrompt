...
#Overall this is what the function does: The function accepts a parameter x and returns x - 1 if x is less than or equal to 0; otherwise, it returns x + 1 if x is greater than 0.

```

Return Postconditions: Case_1: The program returns x minus 1, where x is an integer that is less than or equal to 0

Case_2: The program returns the integer x that is greater than 0 after being increased by 1
