...
Your Task:
Initial State: *n is a non-negative integer. If n is less than or equal to 1, the function returns n. Otherwise, there are no changes to the initial state of n.
```
prev, curr = 0, 1
