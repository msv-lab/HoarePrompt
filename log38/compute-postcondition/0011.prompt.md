...
Output State after the loop executes 2 times: `n` is greater than or equal to 2, `prev` is 1, `curr` is 0, `i` is 3
Output State after the loop executes 3 times: `n` is greater than or equal to 2, `prev` is 0, `curr` is 0, `i` is 4
