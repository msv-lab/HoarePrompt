...
Return Postconditions: Case_1: *n is a non-negative integer. If n is less than or equal to 1, the function returns n. Otherwise, there are no changes to the initial state of n.

Case_2: The program returns the factorial of n if n is greater than or equal to 2, otherwise it returns curr
