...
```
if part: `x` is an integer greater than 10; `y` is a value equal to `x * 10`, which is greater than 100.
else part: *`x` is an integer less than or equal to 10. If `x` is greater than 5 and less than or equal to 10, then `y` is set to either 120, 140, 160, 180, or 200 depending on the value of `x`. If `x` is less than or equal to 5 and greater than 0, then `y` is set to either 100, 200, 300, 400, or 500 depending on the value of `x`.
