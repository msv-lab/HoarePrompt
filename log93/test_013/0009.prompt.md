...
```
if part: `x` is an integer, `x` is greater than 5 and less than or equal to 10; `y` is either 120, 140, 160, 180, or 200 depending on the value of `x`.
else part: *`x` is an integer less than or equal to 5 and greater than 0. Depending on the value of `x`, `y` is set to either 100, 200, 300, 400, or 500.
