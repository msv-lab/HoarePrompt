...
Return Postconditions: Case_1: The program returns the non-negative integer 'n' which is less than or equal to 1

Case_2: The program returns the result of func_1(n - 1) added to the result of func_1(n - 2), where n is a non-negative integer larger than 1. The statement 'n is greater than 1' is printed during execution.
