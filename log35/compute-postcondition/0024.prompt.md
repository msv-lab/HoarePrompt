...
Your Task:
Initial State: *If count is 0, then numbers list is either empty or contains only elements less than or equal to 1. In this case, total is 0 and count is 0.
```
return None
