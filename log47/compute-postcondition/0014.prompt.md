...
Output State after the loop executes 1 times: `n` is a non-negative integer, `prev` is 0, `curr` is 0, `i` is 1
Output State after the loop executes 2 times: `n` is a non-negative integer, `prev` is 0, `curr` is 0, `i` is 3
Output State after the loop executes 3 times: `n` is a non-negative integer, `prev` is 0, `curr` is 0, `i` is less than or equal to n+1 after incrementing by 1
