...
#Overall this is what the function does: The function accepts a 2D list of integers representing a square matrix and returns the sum of the elements on the main diagonal and the secondary diagonal of the matrix.

```

Return Postconditions: The program returns total, which is equal to the sum of the elements on the main diagonal and the secondary diagonal of the matrix, where matrix is a 2D list of integers representing a square matrix of dimension n×n.
