...
def func_1(matrix):
    ...
    return total
State after the function execution: matrix is a 2D list (square matrix) of integers with dimensions n x n, the function returns total which is the sum of the two main diagonals of the matrix
