...
Your Task:
Initial State: `n` is a non-negative integer less than 10^18, `k` is a positive integer greater than 2 and less than or equal to 10, `i` is 2, `dp[n, k]` is now updated to `dp[n, k] + 9 * 10`
```
