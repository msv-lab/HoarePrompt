...
```
Output state after the execution of the try statement: x is an integer.
Output state after the execution of the except statement(s): 
except_1: the state is unknown, and 'An error occurrqqqed' is printed
