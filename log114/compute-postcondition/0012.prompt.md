...
Your Task:
Initial State: `total` is equal to the sum of the main diagonal and anti-diagonal elements of `matrix`, `n` is a positive integer, `matrix` is a 2D list of integers representing a square matrix of dimension n×n.
```
return total
