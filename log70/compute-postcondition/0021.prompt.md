...
```
if part: `numbers` is a list of integers with at least 3 integers, `num` is the third integer in the list, and `medium` is increased by 1
else part: variable `low` is increased by 1
