...
```
if part: variable `medium` is increased by 1
else part: `numbers` is a list of integers with at least 2 integers, `num` is the second integer in the list, and `low` is increased by 1
