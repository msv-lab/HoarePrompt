...
Your Task:
Initial State: `balances` is [0, B], `amount` is a non-negative integer representing the desired transfer amount, and the amount is greater than the balance of Account A.
```
B = B + A
