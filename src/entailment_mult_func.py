...
''' 
 ...
 Output decription for function1:  The function accepts 2 numbers as input, if number 1 is divisible than number2 then the function returns True.
Function nummber 2 :
 Code:
 '''
def is_not_prime(n):
...
Output description for function 2:  The function returns True if n is less than 2 or if n is divisible by any integer in the range [2, n). Otherwise, it returns False.
...
''' 
 ...
 Output decription for function1:  The function accepts a string and returns the size of that string
Function nummber 2 :
 Code:
 '''
...
def binary_search(arr, target):
    ...
    return -1
```
Output description for function number 1 : The function returns the index of the target number in the input list `arr` if it is present; otherwise, it returns -1. If the taget is at the last index it wont be found as the loop will break before reaching the last index.
