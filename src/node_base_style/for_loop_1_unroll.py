...
Provide the state in Natural language easily understandable by humans. Use the fomrat Output State: **the output state you calculate**
"""
...
The output state after the loop executes 1 time includes what needed to be true for the loop to execute at least that first time:
{loop_unrolled}
