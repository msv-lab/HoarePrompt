...
Your Task:
Initial State: `matrix` is a square matrix ((n+1) x (n+1)) where n is a positive integer greater than 0, `total` is the updated sum of all diagonal elements of the matrix
```
