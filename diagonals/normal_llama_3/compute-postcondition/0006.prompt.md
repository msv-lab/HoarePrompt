...
Your Task:
Initial State: `matrix` is a square list of lists of integers, `n` is greater than 1, `total` is the sum of the top-left and top-right elements of `matrix`, `i` is 1
```
total += matrix[i][i]
