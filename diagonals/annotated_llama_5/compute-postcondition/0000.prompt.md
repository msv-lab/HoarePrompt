...
Your Task:
Initial State: matrix is a square list of lists of integers, i.e., a 2D list where all inner lists have the same length as the outer list, and this length is a positive integer.
```
n = len(matrix)
