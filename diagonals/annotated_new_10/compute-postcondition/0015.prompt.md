...
#Overall this is what the function does: The function accepts a square matrix with dimensions n x n, where n is a non-negative integer, and returns 0.

```

Return Postconditions: `total` is the sum of the diagonal and anti-diagonal elements of the matrix, `n` is a non-negative integer, `i` is at least 0, and the function returns 0
