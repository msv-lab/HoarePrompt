...
Your Task:
Initial State: matrix is a square matrix (n x n) where n is a non-negative integer. Each element of the matrix is a number; n represents the side length of the square matrix.
```
total = 0
