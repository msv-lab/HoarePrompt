...
Initial State: `n` is the number of rows or columns in the square matrix, `total` is 0
Code of the loop:
```
for i in range(n):
    total += matrix[i][i]
...
```
Output State after the loop executes 1 times: `n` is greater than or equal to 1, `total` has been further updated, `i` is 0
Output State after the loop executes 2 times: `n` is greater than or equal to 1, `total` has been further updated, `i` is 1
Output State after the loop executes 3 times: `n` is greater than or equal to 1, `total` has been further updated, `i` is 2
