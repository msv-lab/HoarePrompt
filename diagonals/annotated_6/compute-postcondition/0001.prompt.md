...
Your Task:
Initial State: Precondition: matrix is a square 2D list of integers with dimensions n x n, where n is a non-negative integer; `n` is the number of rows or columns of the square matrix.
```
total = 0
