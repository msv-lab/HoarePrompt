...
Your Task:
Initial State: `matrix` is a square list of lists of integers, `n` is at least 1, `total` is the value of the first element of the first sublist in `matrix`, `i` is 0
```
