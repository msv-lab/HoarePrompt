...
Your Task:
Precondition: `numbers` is a list of integers, `i` is 0, `skipped` is 0, `total` is 0
Program Fragment:
```
if numbers[i] > 0:
    total += numbers[i]
...
```
if part: `numbers` is a list of integers, `i` is 0, `skipped` is 0, `total` is updated to total + numbers[0] (where numbers[0] > 0)
else part: `numbers` is a list of integers, `i` is 0, `skipped` is 1, `total` is 0
