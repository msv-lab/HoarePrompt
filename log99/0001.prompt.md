...
def func_1(matrix):
    ...
    return total
#State after the function execution: matrix is a square 2D list (n x n) of integers, the function returns total which is the sum of the two main diagonals of the matrix
