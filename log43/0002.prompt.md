...
Your Task:
State at the end of the previous iteration: counter is an integer greater than 0 (one less than its initial value), total is the previous total value plus the counter value
```
while counter > 0:
    # the loop body is omit
```
