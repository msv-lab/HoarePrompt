...
Output State after the loop executes 1 times: counter is an integer greater than 0 (one less than its initial value), total is the previous total value plus the counter value
