...
Your Task:
Initial State: `numbers` has at least one element remaining in the list, and appropriate adjustments are made to `total`, `count`, and a message is printed if necessary.
```
num = numbers.pop()
