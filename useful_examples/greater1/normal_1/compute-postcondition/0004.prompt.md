...
Your Task:
Initial State: numbers is a list of integers with one less element, total is updated with the sum of the popped integer value, count is 0, num is the popped integer value
```
count += 1
