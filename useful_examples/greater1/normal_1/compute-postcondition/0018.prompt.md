...
Your Task:
Precondition: `numbers` is a list of integers with at least one element removed, `num` is the popped integer, `total` may have been increased if `num` was greater than 1, `count` may have been incremented, or 'Skipping non-positive number: num' message has been printed
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is a list of integers with at least one element removed, `num` is the popped integer, `total` may have been increased if `num` was greater than 1, `count` is incremented, or 'Skipping non-positive number: num' message has been printed
else part: `numbers` is a list of integers with at least one element removed, `num` is the popped integer, `total` may have been increased if `num` was greater than 1, `count` may have been incremented, or 'Skipping non-positive number: num' message has been printed
