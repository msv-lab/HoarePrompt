...
Your Task:
Precondition: numbers is a list of integers with one less element, total is 0, count is 0, num is the popped integer value
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: numbers is a list of integers with one less element, total is updated with the sum of the popped integer value, count is 1, num is the popped integer value
else part: numbers is a list of integers with one less element, total is 0, count is 0, num is the popped integer value
