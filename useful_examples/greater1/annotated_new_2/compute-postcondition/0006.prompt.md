...
Your Task:
Precondition: `numbers` has the last element removed, `total` is 0, `count` is 0, and `num` is the last element of the list
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` has the last element removed, `total` is the sum of its previous value and the last element of the list, `count` is 1, `num` is the last element of the list
else part: `numbers` has the last element removed, `total` is 0, `count` is 0, and `num` is the last element of the list
