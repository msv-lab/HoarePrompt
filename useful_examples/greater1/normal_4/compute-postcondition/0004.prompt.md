...
Your Task:
Initial State: numbers list has one less element, total is updated to include the value of num, count is incremented by 1, num is the last integer removed from the list
```
count += 1
