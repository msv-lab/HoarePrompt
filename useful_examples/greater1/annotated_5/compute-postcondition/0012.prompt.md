...
Your Task:
Precondition: `numbers` is [1], `total` is either 3 with `count` being 1 or 0 with `count` being 0, `num` is 2
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is [1], `total` is 5 with `count` being 2 or 1, `num` is 2
else part: `numbers` is [1], `total` is either 3 with `count` being 1 or 0 with `count` being 0, `num` is 2
