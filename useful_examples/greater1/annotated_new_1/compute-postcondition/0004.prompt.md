...
Your Task:
Initial State: numbers list has one less element (depending on the original list), total is increased by the value of the removed element, count is 0, `num` has the value of the removed element
```
count += 1
