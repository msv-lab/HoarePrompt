...
Your Task:
Precondition: numbers is a list of integers with one less element, total is 0, count is 0, num is the popped integer
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: numbers is a list of integers with one less element, total is updated with the addition of `num`, count is 1, and num is the popped integer
else part: numbers is a list of integers with one less element, total is 0, count is 0, num is the popped integer
