...
Your Task:
Precondition: `numbers` is a list of numbers with the last element removed; `num` is the removed last element
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `numbers` is a list of numbers with the last element removed; `num` is the removed last element, `total` is the sum of the previous total and the removed last element, `count` is incremented by 1
else part: `numbers` is a list of numbers with the last element removed; `num` is the removed last element
