...
Your Task:
Initial State: `numbers` is a list of integers with the last element removed, `total` is the sum of the removed element, `count` is 0, `num` contains the value of the removed element
```
count += 1
