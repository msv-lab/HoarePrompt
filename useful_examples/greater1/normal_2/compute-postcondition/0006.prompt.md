...
Your Task:
Precondition: numbers has the last element removed, total is 0, count is 0
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: numbers have the last element removed, `total` is the sum of all the removed elements, `count` is 1
else part: numbers has the last element removed, total is 0, count is 0
