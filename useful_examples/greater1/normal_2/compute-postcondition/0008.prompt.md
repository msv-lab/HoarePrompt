...
Your Task:
Initial State: numbers have the last element removed. If num is greater than 1, total is updated with the sum of all removed elements, count is updated to 1. If num is not greater than 1, total and count remain unchanged.
```
num = numbers.pop()
