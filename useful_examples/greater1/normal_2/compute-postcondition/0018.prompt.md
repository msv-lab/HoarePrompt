...
Your Task:
Precondition: Adjust based on the next number in the list and whether it satisfies the condition for updating total and count
Program Fragment:
```
if num > 1:
    total += num
...
```
if part: `total` is updated based on the next number in the list and condition satisfaction; `count` is increased by 1
else part: Adjust based on the next number in the list and whether it satisfies the condition for updating total and count
