...
#Overall this is what the function does: The function accepts a square 2D list of integers with dimensions n x n, updates total based on matrix values if n is positive, and keeps total as 0 if n is 0 or negative.

```

Return Postconditions: If n is greater than 0, the loop will update total based on the matrix values; If n is 0 or negative, total will remain 0
