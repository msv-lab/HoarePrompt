...
Your Task:
State at the end of the previous iteration: `total` is increased by the sum of values in the diagonal from the top right to the bottom left of the matrix
```
for i in range(n):
    # the loop body is omit
```
