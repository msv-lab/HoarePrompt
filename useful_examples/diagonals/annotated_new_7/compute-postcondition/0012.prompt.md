...
```
Output State after the loop executes 1 times: `total` is updated based on the value at the diagonal of the matrix
Output State after the loop executes 2 times: `total` is updated based on the value at the diagonal of the matrix, `i` is incremented by 1, `n` is greater than the new value of `i`
Output State after the loop executes 3 times: `total` is updated based on the value at the diagonal of the matrix, `i` is incremented by 2, `n` is greater than the new value of `i + 1`
