...
Your Task:
Initial State: total is updated based on the values at the diagonals of the matrix. If n is less than or equal to 0, the loop does not execute and total remains 0
```
return total
