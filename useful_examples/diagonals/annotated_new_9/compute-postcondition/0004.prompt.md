...
Your Task:
Initial State: matrix is a square matrix (n x n) where n is a positive integer, total is updated with the value of the diagonal element at index i=i, n is at least 1, i is increased by 1
```
