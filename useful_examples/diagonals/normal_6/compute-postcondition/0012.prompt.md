...
```
Output State after the loop executes 1 times: `total` is updated according to the new value at position `[0][0]` in the `matrix`, `i` is 0, `n` is greater than 0
Output State after the loop executes 2 times: `total` is updated according to the new value at position [1][1] in the matrix
Output State after the loop executes 3 times: `total` is updated according to the new value at position [1][1] in the matrix, `i` is incremented by 1, `n` remains the same
