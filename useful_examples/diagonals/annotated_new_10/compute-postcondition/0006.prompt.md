...
Your Task:
Initial State: matrix is a square matrix with dimensions n x n, `total` is the sum of the diagonal and anti-diagonal elements of the matrix, `n` is greater than 0, `i` is n-1
```
total += matrix[i][i]
