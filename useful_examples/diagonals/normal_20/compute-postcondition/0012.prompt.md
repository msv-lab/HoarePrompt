...
```
Output State after the loop executes 1 times: `total` is updated to a new value based on the matrix elements, `n` is greater than or equal to 1, `i` is 0
Output State after the loop executes 2 times: `total` is updated based on the matrix elements, `n` is greater than or equal to 1, `i` is 1
Output State after the loop executes 3 times: `total` is updated based on the matrix elements, `n` is greater than or equal to 1, `i` is 2
