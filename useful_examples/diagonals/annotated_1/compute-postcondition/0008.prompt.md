...
Your Task:
State at the end of the previous iteration: `total` is updated with the sum of the previous total and the value of the element in the 2nd row and last column of the matrix
```
for i in range(n):
    # the loop body is omit
```
