...
Your Task:
Initial State: `matrix` is a 2D list of integers, `n` is greater than 1, `total` is the sum of the top-left, top-right, and middle elements of the first row of `matrix`, `i` is 1
```
