...
Your Task:
Initial State: matrix is a square 2D list of integers, i.e., a list of lists where all inner lists have the same length as the outer list, and this length is a positive integer.
```
n = len(matrix)
