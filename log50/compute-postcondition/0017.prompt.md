...
#Overall this is what the function does: The function accepts a non-negative integer n. If n is less than or equal to 1, it returns n. If n is greater than 1, it returns the value of the variable curr.

```

Return Postconditions: Case_1: The program returns the non-negative integer 'n' that is less than or equal to 1

Case_2: The program returns the value of variable 'curr'.
