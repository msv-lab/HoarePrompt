...
```
if part: x is an integer and x is greater than 0, y is 'positive'
else part: *x is an integer, x is less than or equal to 0. If x is equal to 0, y is 'zero'. If x is less than 0, y is 'negative'.
