...
Output State after the loop executes 1 times: outer_counter and inner_counter are integers greater than 0, total is the initial value of total plus the updated value of inner_counter
