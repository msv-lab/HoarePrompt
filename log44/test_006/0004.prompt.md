...
Your Task:
Initial State: outer_counter and inner_counter are integers greater than 0, total is the sum of all numbers from 1 to the initial value of inner_counter
```
outer_counter -= 1
