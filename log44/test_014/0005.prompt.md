...
Your Task:
Initial State: *a, b, and c are integers. The value of a is greater than the value of b. The value of b is less than or equal to the value of c. The value of c is greater than the value of a
```
x = c - b
