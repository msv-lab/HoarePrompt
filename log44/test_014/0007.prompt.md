...
Your Task:
Initial State: *a, b, and c are integers. The value of a is greater than the value of b. The value of b is less than or equal to the value of c. The condition (c > a) is false
```
x = a + b
