...
Your Task:
Precondition: *x is an integer and x is less than or equal to 10
Program Fragment:
```
if x > 5:
    y = 20 * x
...
```
if part: `x` is an integer and x is less than or equal to 10. x is greater than 5; `y` is a value greater than 100
else part: *`x` is an integer and x is less than or equal to 10. If x is greater than 0, y is a multiple of 100 within the range of 100 to 1000. If x is less than or equal to 0, there is no change in the values of x and y.
