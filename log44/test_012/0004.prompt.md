...
Your Task:
Initial State: *x, y, z are integers. If x > 0, y is updated to be the sum of its previous value and x. All other variables remain unchanged. y is a negative value
```
z -= y
