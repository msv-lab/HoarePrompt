...
Your Task:
Initial State: `matrix` is a square 2D list of numbers with dimensions n x n, `total` is equal to the sum of all diagonal and anti-diagonal elements of the matrix, `n` is a non-negative integer.
```
return total
