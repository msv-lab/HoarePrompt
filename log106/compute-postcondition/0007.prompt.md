...
Your Task:
Initial State: `matrix` is a square 2D list of numbers with dimensions n x n, `total` is equal to `matrix[0][0] + matrix[0][n - 1] + matrix[1][1]`, `i` is 1, `n` must be greater than 1.
```
