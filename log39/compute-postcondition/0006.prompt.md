...
Your Task:
State at the end of the previous iteration: `n` is greater than 1, `i` is 2, `prev` is the previous value of `curr`, and `curr` is the product of the previous values of `prev` and `curr
```
