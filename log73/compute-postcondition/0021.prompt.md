...
```
if part: `tasks` is a list of strings with at least 3 tasks, `running` is True, `completed` is incremented by 1, `pending` is 1, and `task` is the third task in the list
else part: `tasks` is a list of strings with at least 3 tasks, `running` is True, `completed` is incremented by 1, `pending` remains 0, and `task` is the third task in the list; printed 'Unknown task'
