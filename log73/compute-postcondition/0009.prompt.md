...
Your Task:
Precondition: *`tasks` is a list of strings with at least 1 task, `running` is True, `completed` is 0, `pending` is 0, `task` is the first task in the list, and `task` is not equal to 'complete'.
Program Fragment:
```
if task == 'pending':
    pending += 1
...
```
if part: `tasks` is a list of strings with at least 1 task, `running` is True, `completed` is 0, `pending` is 1, `task` is the first task in the list, `task` is not equal to 'complete', and `task` is equal to 'pending'.
else part: `tasks` is a list of strings with at least 1 task, `running` is True, `completed` is 0, `pending` is 0, `task` is the first task in the list, `task` is not equal to 'complete', and `task` is not equal to 'pending'; 'Unknown task' is printed.
