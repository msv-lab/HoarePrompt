...
```
if part: `tasks` is a list of strings containing at least 2 tasks, `running` is True, and `pending` is increased by 1.
else part: `tasks` is a list of strings containing at least 2 tasks, `running` is True, and 'Unknown task' is printed to the output.
