...
Your Task:
Initial State: tasks is a list of strings where each string is either 'complete' or 'pending', and running is a boolean indicating whether the tasks should continue to be processed.
```
