...
Your Task:
Precondition: *numbers is a list of integers, total is 0, count is 0, and the length of numbers is not equal to 0
Program Fragment:
```
if len(numbers) == 1:
    return numbers[0]
...
```
if part: The program returns the first integer in the list 'numbers'
else part: The program returns the average value of all integers in the list 'numbers'
