...
```
if part: `x` is an integer, `x` is either 6, 7, 8, 9, or 10; `y` is either 120, 140, 160, 180, or 200
else part: *`x` is an integer less than or equal to 10 and less than or equal to 5. If `x` is greater than 0, then `y` is either 100, 200, 300, 400, or 500. If `x` is less than or equal to 0, there are no changes to `y`.
