...
Your Task:
Initial State: `outer_counter` is greater than 0, `inner_counter` is now one less than its previous value and greater than 1; `total` is adjusted to `3 * inner_counter - 1
```
inner_counter -= 1
