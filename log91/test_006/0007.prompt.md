...
Your Task:
State at the end of the previous iteration: `outer_counter` is greater than 0, `inner_counter` is now one less than its previous value, `total` is `2 * inner_counter - 1
```
