...
Your Task:
Initial State: `counter` is an integer greater than 0 after being decremented by 1, and for the loop to execute again `counter` must be at least 2 before the decrement.
```
total += counter
