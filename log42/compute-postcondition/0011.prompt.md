...
#Overall this is what the function does: The function accepts a non-negative integer `n`. If n is less than or equal to 1, it returns n. If n is greater than 1, it returns the value stored in 'curr'.

```

Return Postconditions: Case_1: *n is a non-negative integer. If n is less than or equal to 1, the program returns n. Otherwise, there is no change in the state of the variables after the execution of the program fragment.

Case_2: The program returns the value stored in 'curr'
