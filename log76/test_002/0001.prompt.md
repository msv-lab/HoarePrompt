...
Your Task:
Initial State: `total` is 0, for the loop to execute the first time `numbers` is a list of integers with at least 1 integer, `num` is the first integer in the list
```
total += num
