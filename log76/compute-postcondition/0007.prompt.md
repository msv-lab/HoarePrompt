...
#Overall this is what the function does: The function accepts a parameter x and returns x increased by 1 if x is greater than 0; returns -1 if x is 0; and returns 0 if x is -1.

```

Return Postconditions: The program returns x, which is either increased by 1 if initially greater than 0, or decreased by 1, resulting in -1 or -2 if it was originally 0, or 0 if it was originally -1.
