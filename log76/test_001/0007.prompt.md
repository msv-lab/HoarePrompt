...
```
Output State after the loop executes 1 times: `total` is 0, `n` is greater than 0, `i` is 0
Output State after the loop executes 2 times: `total` is 1, `n` is greater than 0, `i` is 1
Output State after the loop executes 3 times: `total` is 3, `n` is greater than 1, `i` is 2
