...
```
Output State after the loop executes 1 times: `n` is greater than or equal to 2, `i` is 2, `prev` is updated, `curr` is updated
Output State after the loop executes 2 times: `n` is greater than or equal to 3, `i` is 2, `prev` and `curr` are updated
Output State after the loop executes 3 times: `n` is greater than or equal to 3, `i` is 3, `prev` is updated, `curr` is updated
